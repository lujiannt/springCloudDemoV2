...
Source Database       : demo_oauth

Target Server Type    : MYSQL
Target Server Version : 50727
File Encoding         : 65001

Date: 2019-09-12 11:16:47
*/
...
CREATE TABLE `qrtz_logs` (
  ...
  `COSTTIME` bigint(12) DEFAULT NULL,
...
CREATE TABLE `quartz_schedulejob` (
  ...
  `CONCURRENT` varchar(255) DEFAULT NULL COMMENT '是否并发',
  `DESCRIPTION` varchar(255) DEFAULT NULL COMMENT '简介',
  `JOB_GROUP` varchar(255) DEFAULT NULL COMMENT '分组',
  `TARGET_TASK` varchar(255) DEFAULT NULL COMMENT '目标任务类',
  PRIMARY KEY (`ID`)
